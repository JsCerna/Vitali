...
import cardData2 from "./Cardata2";
...
function Servicios2() {
  ...
  const currentCards = cardData2.slice(indexOfFirstCard, indexOfLastCard);
    ...
    <Container fluid className="project-section">
      <Container>
        <h1 className="project-heading">
          Tratamientos <strong className="purple">Faciales </strong>
        </h1>
        <p style={{ color: "black" }}>Principales tratamientos faciales.</p>
        ...
        <Pagination>
          {Array.from({ length: Math.ceil(cardData2.length / cardsPerPage) }, (_, index) => (
            <Pagination.Item
              key={index}
